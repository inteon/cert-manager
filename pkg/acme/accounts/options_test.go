...
func testRegistryItem(t *testing.T) (RegistryItem, *v1.ACMEIssuerStatus) {
...
func Test_Register(t *testing.T) {
	...
	for i, tt := range []testCase{
		...
		t.Run(fmt.Sprintf("item-%d", i), func(t *testing.T) {
			ri, expStatus := testRegistryItem(t)
