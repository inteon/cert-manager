...
import (
	...
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/acmedns"
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/akamai"
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/azuredns"
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/clouddns"
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/cloudflare"
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/digitalocean"
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/rfc2136"
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/route53"
	"github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/util"
	webhookslv "github.com/cert-manager/cert-manager/core-issuers-binary/issuer/acme/dns/webhook"
